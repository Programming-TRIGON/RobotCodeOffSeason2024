...
public class VisualizeNoteShootingCommand extends Command {
    ...
    private Translation3d noteExitPointFieldRelativeTranslation;
    ...
    public void initialize() {
        ...
        noteExitPointFieldRelativeTranslation = startingEndEffectorFieldRelativePose.getTranslation();
    ...
    public void execute() {
        ...
        final Pose3d notePose = new Pose3d(noteExitPointFieldRelativeTranslation, new Rotation3d()).plus(transform);
