...
public class LEDStripConstants {
    ...
    public static final LEDStrip
            RIGHT_CLIMBER_LEDS = new LEDStrip(RIGHT_CLIMBER_INVERTED, RIGHT_CLIMBER_NUMBER_OF_LEDS - 1, LEFT_CLIMBER_NUMBER_OF_LEDS - 1),
            LEFT_CLIMBER_LEDS = new LEDStrip(LEFT_CLIMBER_INVERTED, LEFT_CLIMBER_NUMBER_OF_LEDS, 0);
